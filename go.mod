...
// rotation (they can, as long as the old key is still present in the cluster).
// Key rotation period default is 30 days; worth experimenting with shorter
// values locally to observe the rotation flow end-to-end.
